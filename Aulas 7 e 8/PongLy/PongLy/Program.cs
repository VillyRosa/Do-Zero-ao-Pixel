...
namespace PongLy
{
    internal class Program : GameWindow
    {
        ...
        int xDaBola = 0, yDaBola = 0;
        // Tamanho da bola em px
        int tamanhoDaBola = 20;
        // Velocidade da bola (quantos pxs a bola vai se movimentar por segundo)
        int velocidadeDaBolaEmX = 3, velocidadeDaBolaEmY = 3;


        // Configurações dos Jogadores

        // Posição dos jogadores na tela
        int yDoJogador1 = 0, yDoJogador2 = 0;
